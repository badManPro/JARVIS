...
### 当前总进度
- **整体进度估算：99%**
- **当前阶段：Phase 6 进行中，下一任务为 `Phase 6 / Task 2`（为关键链路补集成级验证）**
...
### 当前最该做的事情
- **Phase 6 / Task 2：为关键链路补集成级验证。**

这一步应该把画像、目标、计划、对话建议、执行复盘和设置页 runtime 等关键链路串成更稳定的集成级验收基线，为后续打包与安装体验检查扫清剩余回归风险。
...
| Phase 6 | 发布准备与质量收口 | in_progress | 25% | 完成验收、打包、发布前检查 |
...
- **当前进展：**
  ...
  - 项目当前唯一下一任务：**Phase 6 / Task 2 / 为关键链路补集成级验证**
- **本阶段完成后指定的下一个任务：**
