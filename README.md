...
## 当前阶段
当前判断：
- 当前阶段：`Phase 4 / 首发领域深做（待开始）`
- 当前进度估算：约 `75%`
- 当前唯一下一任务：`Phase 4 / Task 1 / 定义编程领域执行规则、资源建议与任务原子`
...
## 下一步建议
1. `Phase 4 / Task 1`：定义编程领域执行规则、资源建议与任务原子
2. `Phase 4 / Task 2`：定义乐器领域执行规则、资源建议与任务原子
3. `Phase 5 / Task 1`：为关键状态流转补强反馈和轻动效

## 当前推荐下一任务
- `Phase 4 / Task 1`：定义编程领域执行规则、资源建议与任务原子
